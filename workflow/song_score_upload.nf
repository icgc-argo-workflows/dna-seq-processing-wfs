...
include extractAnalysisId from '../process/utils'
...
workflow songScoreUpload {
    ...
    main:
        ...
        analysis_id = extractAnalysisId(songSubmit.out)

        // Generate file manifest for upload
        songManifest(study_id, analysis_id, upload)

        // Upload to SCORE
        scoreUpload(analysis_id, songManifest.out, upload)
