...
include songSubmit as songSub from '../modules/raw.githubusercontent.com/icgc-argo/nextflow-data-processing-utility-tools/song-submit-fix/process/song_submit' params(song_params)
include songManifest as songMan from '../modules/raw.githubusercontent.com/icgc-argo/nextflow-data-processing-utility-tools/song-submit-fix/process/song_manifest' params(song_params)
include scoreUpload as scoreUp from '../modules/raw.githubusercontent.com/icgc-argo/nextflow-data-processing-utility-tools/song-submit-fix/process/score_upload' params(score_params)
include songPublish as songPub from '../modules/raw.githubusercontent.com/icgc-argo/nextflow-data-processing-utility-tools/song-submit-fix/process/song_publish' params(song_params)
