...
steps:
  ...
  sequence_download:
    run: https://raw.githubusercontent.com/icgc-argo/data-processing-utility-tools/score-download.0.1.4/tools/score-download/score-download.cwl
    in:
      seq_files: seq_files
      file_tsv: file_tsv
  ...
  lane_seq_payload_gen_and_s3_submit_wf:
    run: https://raw.githubusercontent.com/icgc-argo/dna-seq-processing-wfs/0.2.3/workflows/payload-gen-and-s3-submit-wf/cwl/payload-gen-and-s3-submit-wf.cwl
    in:
  ...
  alignment:
    run: https://raw.githubusercontent.com/icgc-argo/dna-seq-processing-wfs/0.2.3/workflows/bwa-mem-subwf/cwl/bwa-mem-subwf.cwl
    in:
