...
include SequencingDataSubmission as SequencingDataMigration from "../sequencing-data-submission/sequencing-data-submission.nf" params(
  "wf_version": workflow.manifest.version, "song_url": params.song_url, "score_url": params.score_url, "token_file": params.token_file
)
