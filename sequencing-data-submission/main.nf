...
include FileProvisioner as FP from "../modules/raw.githubusercontent.com/icgc-argo/data-processing-utility-tools/file-provisioner.0.1.1.1/tools/file-provisioner/file-provisioner.nf" params(params)
